...
describe("Resolver with local container and uniqueId", () => {
    ...
    test("Should resolve existing instance", async () => {
        ...
        @pipelineBehavior("MyBehaviourTest")
    ...
    test("Should resolve existing instance with multiple behaviors", async () => {
        // Arrange
        mediatorSettings.resolver = new Resolver();
        ...
        @pipelineBehavior("BehaviorTest1")
        ...
        @pipelineBehavior("BehaviorTest2")
