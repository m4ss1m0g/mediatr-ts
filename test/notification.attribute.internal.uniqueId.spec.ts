...
describe("The notification attribute with uniqueId", () => {
    ...
    test("Should add instance to dispatcher and resolver", () => {
        ...
        // Act
        @notificationHandler(Ping, "MyPing")
    ...
    test("Should resolve and call the notification in specific order when", () => {
        ...
        mediatorSettings.dispatcher.notifications.add({ notification: Ping, handler: Pong2, order: 2, uniqueId: "MyPong2" });
        mediatorSettings.dispatcher.notifications.add({ notification: Ping, handler: Pong1, order: 1, uniqueId: "MyPong1" });
    ...
    test("Should resolve all notification without order field", ()=>{
        ...
        @notificationHandler(Ping, "Ping1")
        class Pong1 implements INotificationHandler<Ping> {
        ...
        @notificationHandler(Ping, "Ping2")
        class Pong2 implements INotificationHandler<Ping> {
