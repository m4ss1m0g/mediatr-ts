...
- Add the possibility to specify an identifier for the handler class, this is due to duplicated name when source code is minified
- Add the possibilty to specify the identifier also for behaviour and notifications
